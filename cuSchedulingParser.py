...
def	superMain(term,classes,hardTime,timeOfDay):
	...
	if	len(rankedResults)	>=	10:
		...
		for potentialSched in bestFive:
			toBeCopied.append(potentialSched)
	
	for	sched	in	toBeCopied:
...
print(superMain("Winter",["COMP1406","COMP1805","ENST1020","NEUR1202","STAT2507"],"12:00","Afternoon"))